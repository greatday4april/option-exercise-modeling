...
FYS = {
    "2022": FY(
        "Dec 31 2022",
        238625 * 0.9 * 10 / 12 + 230000 * 2 / 12 + 17250,
        141900 * 2 / 12 + 120615 * 10 / 12 + 37500,
        236000 * 3 / 16,
        0,
    ),
    "2023": FY(
    ...
    "2024": FY(
        ...
        120615 * 1.1 * 1.1,
        236000 * (1 / 4 + 1 / 4 + 9 / 48),
        146666 * (1 / 4) + 90000 * (1 / 4 + 3 / 16),
    ),
    "2025": FY(
        "Dec 31 2025",
        246976,
        120615 * 1.1 * 1.1 * 1.1,
        236000 * (1 / 16 + 1 / 16 + 1 / 16),
        146666 * (1 / 4) + 120000 * (1 / 4 + 1 / 4 + 3 / 16),
    ),
}
